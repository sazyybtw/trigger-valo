# fZW008RgrfMeKWkW6qtnis5WdlnTuq
import sys, os, time, random, ctypes, json, threading
from multiprocessing import Process, Queue
import cv2, numpy as np, pyautogui
import win32api, win32con
from PyQt5 import QtWidgets, QtCore, QtGui
# 8q9Tr7ifzIQjIvs6j1oYo0z1tL3g0l
import bettercam
# BHCe8Xj3wgRHxNlhrLkPhOBi4Sv24Nq

# FvXZtqFajzAqGhz7yffR
# Global shutdown event used by the trigger bot process.
shutdown_event = threading.Event()
# bkrPk3L9anHetvnKvjGuQSq0R39znP# UI-DO-NOT-OBFUSCATE-START
...
# wqwKEburf4zy0iXUdcGn0H3c7WMIuU
#op: 65.0,
#guardian: 250.0,
# eqsLtnfppSm97KXphFMqs
#vandal: 300.0,
#ghost: 350.0,
# u4CfCneafCNDlScwlr5gFTm2Ww9T5R7
#sheriff: 400.0,
# QUSmNBtaqGVyqkJ6oIOWnD1V0MPNqA